...
def get_model():
    ...
    plt.imsave('filt0.jpg', cv2.resize(filters[:, :, :, 0], (800, 800), interpolation="nearest"))
    plt.imsave('filt1.jpg', cv2.resize(filters[:, :, :, 1], (800, 800), interpolation="nearest"))
    plt.imsave('filt2.jpg', cv2.resize(filters[:, :, :, 2], (800, 800), interpolation="nearest"))
